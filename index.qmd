...
Git, pytest, GitHub Actions, GitLab Workflows, Docker, uv, pyenv
...
**Data visualization.** Given that I am a mathy guy who works with both physicists and biological scientists, 
...
Mentoring is an important aspect of my professional profile.
Knowledge sharing is powerful in industry and academia, and good mentoring can vitalize teams' productivity, especially in cross-functional and interdisciplinary teams.
These are the research projects I have had the priviledge of mentoring:

- **Kendall Salazar, U of Costa Rica.** Research project on RL for multi-species Lotka-Volterra harvesting problems.
- **Aaron Sanabria, U of Costa Rica.** Research project on MCMC and statistical estimation for heavy-ion collision data.
- **Maxwell Tanguchi-King, UC Berkeley.** Internship on software development and indigenous data sovereignty in biodiversity monitoring.
- **Nithya Appannagaari, UC Berkeley.** Internship on software development and indigenous data sovereignty in biodiversity monitoring. 
- **Claire Liu, UC Berkeley.** B.Sc. thesis on predictability of extreme rain events in the SF Bay Area. Undergrad research assistantship on RL approaches to partially observable population dynamics control problems.
- **Maya Nalliah, UC Berkeley.** Undergrad research assistantship on RL approaches to highly stochastic and non-stationary population dynamics control problems.
- **Felix Hoeddinghaus, U of Cologne.** B.Sc. thesis on discrete algebraic groups arising in a quantum computing context.
- **Angelos Bampounis, U of Cologne.** M.Sc. thesis on representation theory of the single-qubit Clifford group.
- **Paula Belzig, U of Cologne & ETH Zurich.** M.Sc. thesis on the Stabilizer de Finetti theorem and applications to quantum communication.
- **Tobias Hartmann, U of Cologne.** B.Sc. thesis on state-independent contextuality for few-qubit systems.
- **Stefan Schmit, U of Cologne.** B.Sc. thesis on parametric noise on quantum control problems.

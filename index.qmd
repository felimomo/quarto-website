...
**Agentic AI.** I am rather new to the use of agentic AI tools in the creation of projects, but I am very excited about it!
This website was deployed using the Copilot CLI to set up a CI/CD GitHub workflow. 
I have also used the Copilot CLI to [debug and optimize](https://github.com/felimomo/LotkaVolterraRL/agents?q=is%3Aclosed+author%3A%40me) an ongoing reinforcement learning project.
...
Here I'll list the tech stack I often rely on for my research and teaching. It's mostly centered around Python, but includes other languages:

**ML/Deep learning:** Darts, Gymnasium, Optuna, PyTorch, Ray/RLLib, Scikit-Learn, Scikit-Optimize, Stable Baselines, TensorFlow.  
**Data wrangling:** DuckDB, GeoPandas, ibis, Numpy, Pandas, PosgreSQL, rasterio/rioxarray, SciPy, xarray, tidyverse.  
**Data visualization:** ggplot, plotnine, plotly, seaborn.  
**Environment management:** pyenv, uv.  
**Cloud:** odc.stac, pystac_client.  
**CI/CD:** pytest.  
